...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the location of 'value' is at the end of the list or the beginning of the list,
                // then we can call remove_head or remove_tail to remove 'value'
                ...
                else
                {
                    ...
                    curr.Next!.Prev = curr.Prev; // Connect the node after 'value' to the previous node
                }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                curr.Data = newValue; // Replace the value of the node containing 'oldValue' with 'newValue'
            }
